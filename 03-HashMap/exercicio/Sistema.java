...
public class Sistema {
    ...
    public static void cadastrarAeroporto() throws Exception{
    ...
    public static void removerAeroportos() throws Exception{
        ...
        if(aeroportos.containsKey(busca)) {
            ...
            System.out.println(busca + " removido!!");
        }
        else System.out.println(busca + " não encontrado!!");

    }

    public static void detalharAeroporto() throws Exception{
